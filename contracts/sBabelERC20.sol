...
contract sBabelERC20 is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Babel", "sBABEL", 9) ERC20Permit() {
    ...
    /**
        @notice increases sBABEL supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sBABEL
