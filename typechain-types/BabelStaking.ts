...
export interface BabelStakingInterface extends ethers.utils.Interface {
  functions: {
...
export interface BabelStaking extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BabelStakingInterface;
