...
export interface BabelDistributorInterface extends ethers.utils.Interface {
  functions: {
...
export interface BabelDistributor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BabelDistributorInterface;
