...
export interface BabelTreasuryInterface extends ethers.utils.Interface {
  functions: {
    ...
    "repayDebtWithBABEL(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "repayDebtWithBABEL",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface BabelTreasury extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BabelTreasuryInterface;
  ...
  functions: {
    ...
    sBABELQueue(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    sBABELQueue(overrides?: CallOverrides): Promise<PopulatedTransaction>;
