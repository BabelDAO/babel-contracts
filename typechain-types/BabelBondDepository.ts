...
export interface BabelBondDepositoryInterface extends ethers.utils.Interface {
  functions: {
...
export interface BabelBondDepository extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BabelBondDepositoryInterface;
